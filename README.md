...
1. Ler as preferências do arquivo
2. Rodar o algoritmo genético (evolução em tempo real!)
...
- **Seleção**: Escolhe os melhores indivíduos para reproduzir
- **Crossover**: Mistura as soluções boas entre si (tipo herança genética)
- **Mutação**: Bagunça um pouco para não ficar preso (inovação!)
